...
@AndroidEntryPoint
class DrinksFragment : BaseFragment<FragmentDrinksBinding>(FragmentDrinksBinding::inflate), ItemListener {
...
//
//    }
    private fun createListOfAdapters(vararg list: List<ItemEntity>): List<VerticalAdapter> =
        list.map {
